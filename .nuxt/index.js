...
import nuxt_plugin_bootstrapvue_4307f011 from 'nuxt_plugin_bootstrapvue_4307f011' // Source: ./bootstrap-vue.js (mode: 'all')
import nuxt_plugin_axios_6ac813e2 from 'nuxt_plugin_axios_6ac813e2' // Source: ./axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"htmlAttrs":{"lang":"zh"},"title":"槑先森工作室出品，提供简约式风格web建站模板。","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"keywords","content":"商城系统,nuxt商城,nuxt.js商城,vue商城,vue.js商城,node商城,node.js商城,nuxt商城,vue商城,node商城,网上商城系统,网店系统,购物系统,网上购物系统,电商系统,晒点商城,槑先森"},{"hid":"description","name":"description","content":"不断创作简约式风格web建站模板，独创自选式晒点(Shaidian)商城。提供企业级整套的web解决方案，优质保姆式服务。"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.png"}],"script":[{"src":"https:\u002F\u002Fhm.baidu.com\u002Fhm.js?8ef3c45ebdcb41bd818708bfc0feee27"}],"style":[]},
  ...
  if (typeof nuxt_plugin_bootstrapvue_4307f011 === 'function') {
    await nuxt_plugin_bootstrapvue_4307f011(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_6ac813e2 === 'function') {
    await nuxt_plugin_axios_6ac813e2(app.context, inject)
  }
